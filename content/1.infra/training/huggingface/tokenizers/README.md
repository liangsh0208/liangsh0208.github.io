...
| 文档 | 内容概览 |
|------|----------|
| [00_整体架构与设计理念.md](1.infra/training/huggingface/tokenizers/00_整体架构与设计理念.md) | Pipeline模式、Rust核心实现、Wrapper多态、偏移量追踪设计 |
...
1. 先读 [00_整体架构与设计理念.md](1.infra/training/huggingface/tokenizers/00_整体架构与设计理念.md) 理解整体架构
