...
| 文档编号 | 名称 | 核心内容 | 推荐优先级 |
|----------|------|----------|------------|
| 00 | [00_整体架构与设计理念.md](1.infra/training/megatronlm/00_整体架构与设计理念.md) | 5D并行全景、定位对比、阅读路径 | **必读** |
...
本系列替代了原有旧文档：
- `Megatron-LM架构解析综述.md` → [00_整体架构与设计理念.md](1.infra/training/megatronlm/00_整体架构与设计理念.md)
- `01_数据管道模块.md` → 内容重构
