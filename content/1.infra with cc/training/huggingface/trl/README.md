...
| 文档 | 内容 | 源码位置 |
|------|------|----------|
| [00_整体架构与设计理念.md](1.infra%20with%20cc/training/huggingface/trl/00_整体架构与设计理念.md) | TRL 设计哲学、整体架构图、代码组织 | `trl/` |
...
1. **入门**: 先阅读 [00_整体架构与设计理念.md](1.infra%20with%20cc/training/huggingface/trl/00_整体架构与设计理念.md) 了解设计哲学
