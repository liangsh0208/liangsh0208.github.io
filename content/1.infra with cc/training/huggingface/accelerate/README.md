...
| 序号 | 文档 | 内容概要 | 阅读建议 |
|------|------|---------|---------|
| 00 | [整体架构与设计理念.md](1.infra%20with%20cc/training/huggingface/accelerate/00_整体架构与设计理念.md) | 核心定位、三层状态架构、Borg单例模式、最小侵入设计 | **必读**：建立整体认知 |
...
| 你想了解 | 阅读文档 |
|---------|---------|
| Accelerate 是什么 | [00_整体架构与设计理念.md](1.infra%20with%20cc/training/huggingface/accelerate/00_整体架构与设计理念.md) |
